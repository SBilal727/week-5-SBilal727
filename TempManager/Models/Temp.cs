...
namespace TempManager.Models
{
    public class Temp
    {
        ...
        [Range(-200, 200, ErrorMessage = "Low temperature must be within a range of -200 and 200.")]
        public double? Low { get; set; }

        [Required(ErrorMessage = "High temperature is required.")]
        [Range(-200, 200, ErrorMessage = "High temperature must be within a range of -200 and 200.")]
